...
setwd("/Users/rohitpittu/spark/spark-2.1.0-bin-hadoop2.7/")
...
df <- read.df("/Users/rohitpittu/spark/spark-2.1.0-bin-hadoop2.7/examples/src/main/resources/users.parquet")
write.df(select(df, "name", "favorite_color"), "namesAndFavColors.parquet")
# $example off:generic_load_save_functions$


# $example on:manual_load_options$
df <- read.df("/Users/rohitpittu/spark/spark-2.1.0-bin-hadoop2.7/examples/src/main/resources/people.json", "json")
...
df2 <- sql("SELECT * FROM parquet.`/Users/rohitpittu/spark/spark-2.1.0-bin-hadoop2.7/examples/src/main/resources/users.parquet`")
...
sql("LOAD DATA LOCAL INPATH '/Users/rohitpittu/spark/spark-2.1.0-bin-hadoop2.7/examples/src/main/resources/kv1.txt' INTO TABLE src")
